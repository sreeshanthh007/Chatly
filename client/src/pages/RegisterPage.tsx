...
import { User, Mail, Lock, Eye, EyeOff, MessageCircle, AlertTriangle } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-[420px] bg-surface border border-border p-8 rounded-[16px] shadow-2xl relative z-10 animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <Button
            type="submit"
            className="w-full bg-accent text-background hover:bg-accent-hover font-medium h-11 flex items-center justify-center gap-2 mt-5"
            disabled={isLoading}
          >
            {isLoading ? (
